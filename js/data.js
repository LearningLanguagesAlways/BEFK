...
const COURSE_DATA = {
  ...
  week1: {
    ...
    classVocab: [
      ...
      { en:"silent",    ko:"묵음의",    pron:"SY-lent",     example:"The 'e' in 'love' is silent.",          exKo:"'love'의 'e'는 묵음이에요." },
      ...
      { en:"repeat",    ko:"반복하다",  pron:"ri-PEET",     example:"Please repeat after me.",               exKo:"저를 따라서 반복해 주세요." },
