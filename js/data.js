...
const COURSE_DATA = {
  ...
  ,week8: {
    ...
    vocabulary: [
      ...
      { en:"over",        ko:"~위로 / ~너머",  example:"There is a light over the table.",        exKo:"탁자 위에 조명이 있어요." },
      ...
      { en:"close to",    ko:"~에 가까운",     example:"My house is close to the station.",       exKo:"제 집은 역에 가까워요." },
      { en:"on the way",  ko:"가는 길에",      example:"I will buy milk on the way home.",         exKo:"집에 가는 길에 우유를 살게요." }
    ],

    prepRules: [
      { prep:"at", timeKo:"정확한 시각", timeEx:"at 3:00, at noon, at midnight", placeKo:"특정 지점/장소", placeEx:"at the airport, at home, at the door", koNote:"한국어 '에'와 비슷하지만 영어는 상황마다 달라요" },
      { prep:"on", timeKo:"요일, 날짜", timeEx:"on Monday, on July 4th", placeKo:"표면 위, 거리", placeEx:"on the table, on the wall, on Main Street", koNote:"'~위에' 또는 거리 이름에 사용" },
      { prep:"in", timeKo:"월, 년, 긴 기간", timeEx:"in July, in 2025, in the morning", placeKo:"공간 안, 도시/나라", placeEx:"in the bag, in Atlanta, in Korea", koNote:"'~안에' 또는 도시/나라에 사용" }
    ],

    collocations: [
      { phrase:"arrive at",     ko:"~에 도착하다",   example:"We arrived at the airport early.",       exKo:"우리는 공항에 일찍 도착했어요." },
      { phrase:"good at",       ko:"~을 잘하다",     example:"She is good at English.",               exKo:"그녀는 영어를 잘해요." },
      { phrase:"interested in", ko:"~에 관심 있다",  example:"I am interested in Korean history.",     exKo:"저는 한국 역사에 관심이 있어요." },
      { phrase:"listen to",     ko:"~을 듣다",       example:"He listens to music every day.",         exKo:"그는 매일 음악을 들어요." },
      { phrase:"wait for",      ko:"~을 기다리다",   example:"Please wait for me at the door.",        exKo:"문 앞에서 저를 기다려 주세요." },
      { phrase:"look for",      ko:"~을 찾다",       example:"I am looking for the restroom.",         exKo:"저는 화장실을 찾고 있어요." },
      { phrase:"depend on",     ko:"~에 달려 있다",  example:"It depends on the weather.",             exKo:"그건 날씨에 달려 있어요." },
      { phrase:"get to",        ko:"~에 도달하다",   example:"How do I get to the beach?",             exKo:"해변에 어떻게 가요?" }
    ],
    ...
    prepFill: [
      ...
      { sentence:"My office is ___ Main Street.",          options:["in","on","at"], answer:"on", hint:"거리 이름 -> on" },
      { sentence:"She lives ___ Atlanta.",                 options:["in","on","at"], answer:"in", hint:"도시 -> in" },
      { sentence:"We arrived ___ the hotel at noon.",      options:["in","on","at"], answer:"at", hint:"arrive at (덩어리로 외우기)" },
      { sentence:"He is good ___ cooking.",                options:["in","on","at"], answer:"at", hint:"good at (덩어리로 외우기)" }
    ],

    dialogues: [
      {
        titleKo:"길 안내하기", titleEn:"Giving Directions",
        lines:[
      ...
      {
        titleKo:"호텔에서 시설 찾기", titleEn:"Finding Facilities at a Hotel",
        lines:[
      ...
      {
        titleKo:"전화로 위치 설명하기", titleEn:"Describing a Location on the Phone",
        lines:[
