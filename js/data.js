...
const COURSE_DATA = {
  ...
  ,week6: {
    ...
    vocabulary: [
      ...
      { en:"half past",   ko:"~시 30분",      example:"It is half past six.",                    exKo:"6시 30분이에요." },
      { en:"quarter",     ko:"15분",          example:"It is a quarter past two.",               exKo:"2시 15분이에요." },
      ...
      { en:"noon",        ko:"정오",          example:"Let us meet at noon for lunch.",          exKo:"점심 먹게 정오에 만나요." },
      { en:"midnight",    ko:"자정",          example:"The store closes at midnight.",           exKo:"가게는 자정에 닫아요." },
      { en:"morning",     ko:"아침 / 오전",    example:"I exercise in the morning.",              exKo:"저는 아침에 운동해요." },
      { en:"afternoon",   ko:"오후",          example:"We have a meeting this afternoon.",       exKo:"오늘 오후에 회의가 있어요." },
      { en:"evening",     ko:"저녁",          example:"They watch TV in the evening.",           exKo:"그들은 저녁에 TV를 봐요." },
    ...
    numbers: [
      ...
      { num:"20", word:"twenty", ko:"스물" },{ num:"30", word:"thirty", ko:"서른" },{ num:"40", word:"forty", ko:"마흔" },
      { num:"50", word:"fifty", ko:"쉰" },{ num:"100", word:"one hundred", ko:"백" },{ num:"1000", word:"one thousand", ko:"천" }
    ],
    ...
    timeExamples: [
      ...
      { time:"3:30", say:"It is half past three.",       ko:"3시 30분이에요." },
      { time:"3:45", say:"It is a quarter to four.",      ko:"4시 15분 전이에요." },
      { time:"9:10", say:"It is ten past nine.",          ko:"9시 10분이에요." },
      { time:"9:50", say:"It is ten to ten.",             ko:"10시 10분 전이에요." }
    ],
    ...
    dialogues: [
      {
        ...
        lines:[
          ...
          { speaker:"R", en:"Yes. How about half past two?",                    ko:"네. 2시 30분 어떠세요?" },
          { speaker:"C", en:"That is perfect. Tuesday at two thirty.",          ko:"완벽해요. 화요일 2시 30분이요." },
          { speaker:"R", en:"Great. We will see you then!",                     ko:"좋아요. 그때 뵐게요!" }
        ]
      },
      {
        titleKo:"생일 묻기",
        titleEn:"Asking About Birthdays",
        lines:[
          { speaker:"A", en:"When is your birthday?",                          ko:"생일이 언제예요?" },
          { speaker:"B", en:"My birthday is in October. October fifteenth.",   ko:"제 생일은 10월이에요. 10월 15일이요." },
          { speaker:"A", en:"That is soon! What about your husband?",          ko:"곧이네요! 남편분은요?" },
          { speaker:"B", en:"His birthday is in March. When is yours?",        ko:"남편 생일은 3월이에요. 당신은요?" },
  ...
  ,week7: {
    ...
    /* Regular past (-ed) */
    regularPast: [
      { base:"visit",  past:"visited",  ko:"방문했다" },
      { base:"enjoy",  past:"enjoyed",  ko:"즐겼다" },
      { base:"arrive", past:"arrived",  ko:"도착했다" },
      { base:"call",   past:"called",   ko:"전화했다" },
      { base:"learn",  past:"learned",  ko:"배웠다" },
      { base:"stay",   past:"stayed",   ko:"머물렀다" },
      { base:"travel", past:"traveled", ko:"여행했다" },
      { base:"watch",  past:"watched",  ko:"봤다" }
    ],

    /* Irregular past — very common verbs */
    irregularPast: [
      { base:"go",    past:"went",   ko:"갔다" },
      { base:"buy",   past:"bought", ko:"샀다" },
      { base:"see",   past:"saw",    ko:"봤다" },
      { base:"eat",   past:"ate",    ko:"먹었다" },
      { base:"meet",  past:"met",    ko:"만났다" },
      { base:"take",  past:"took",   ko:"탔다/가졌다" },
      { base:"give",  past:"gave",   ko:"줬다" },
      { base:"make",  past:"made",   ko:"만들었다" },
      { base:"come",  past:"came",   ko:"왔다" },
      { base:"feel",  past:"felt",   ko:"느꼈다" },
      { base:"think", past:"thought",ko:"생각했다" },
      { base:"find",  past:"found",  ko:"찾았다" }
    ],

    /* Past tense fill (choose past form) */
    pastFill: [
      ...
      { sentence:"We ___ the museum last week. (visit)",          options:["visited","visitted"], answer:"visited",  hint:"규칙: +ed" },
      { sentence:"They ___ lunch at noon. (eat)",                 options:["eated","ate"],        answer:"ate",      hint:"eat는 불규칙 -> ate" },
      { sentence:"I ___ my friend at the airport. (meet)",        options:["meeted","met"],       answer:"met",      hint:"meet는 불규칙 -> met" },
      ...
      { sentence:"I ___ my family last night. (call)",            options:["called","calld"],     answer:"called",   hint:"규칙: +ed" }
    ],
  ...
  ,week8: {
    ...
    vocabulary: [
      ...
      { en:"building",    ko:"건물",          example:"That is a very tall building.",           exKo:"저것은 아주 높은 건물이에요." },
      ...
      { en:"far",         ko:"먼",            example:"Is the airport far from here?",           exKo:"공항이 여기서 멀어요?" }
    ],

    /* The big three: in / on / at usage rules */
    prepRules: [
      {
        prep:"at",
        timeKo:"정확한 시각", timeEx:"at 3:00, at noon, at midnight",
        placeKo:"특정 지점/장소", placeEx:"at the airport, at home, at the door"
      },
      {
        prep:"on",
    ...
    /* Preposition fill (in/on/at) */
    prepFill: [
      { sentence:"The meeting is ___ 3 o'clock.",          options:["in","on","at"], answer:"at", hint:"정확한 시각 -> at" },
      { sentence:"My birthday is ___ October.",            options:["in","on","at"], answer:"in", hint:"월 -> in" },
      { sentence:"We have class ___ Monday.",              options:["in","on","at"], answer:"on", hint:"요일 -> on" },
      { sentence:"The keys are ___ my bag.",               options:["in","on","at"], answer:"in", hint:"공간 안 -> in" },
      { sentence:"The book is ___ the table.",             options:["in","on","at"], answer:"on", hint:"표면 위 -> on" },
      { sentence:"I am ___ the airport now.",              options:["in","on","at"], answer:"at", hint:"특정 장소 -> at" },
  ...
  ,week9: {
    ...
    /* Mixed review quiz across weeks 1-8 */
    reviewMixed: [
      ...
      { week:"W6", q:"It is half ___ three. (3시 30분)",             answer:"past",     ko:"3시 30분이에요." },
      ...
      { week:"W8", q:"The meeting is ___ 3 o'clock. (전치사)",        answer:"at",       ko:"회의는 3시예요." },
      { week:"W8", q:"My birthday is ___ October. (전치사)",          answer:"in",       ko:"제 생일은 10월이에요." }
    ],

    /* Vocabulary review — pulled highlights from each week */
    vocabReview: [
      ...
      { en:"schedule",         ko:"일정",             week:"W6" },
      { en:"between",          ko:"~사이에",           week:"W8" },
      { en:"important",        ko:"중요한",            week:"W3" },
      { en:"souvenir",         ko:"기념품",            week:"W5" }
    ],

    /* Grammar checkpoint cards summarizing each week */
    grammarCards: [
      ...
      { week:"Week 6", titleKo:"숫자/시간/날짜", titleEn:"Numbers/Time/Dates", point:"o'clock, half past, quarter; on Monday, in July, at 3:00" },
      { week:"Week 7", titleKo:"과거 시제", titleEn:"Past Tense", point:"Regular +ed; irregular go->went, buy->bought, eat->ate" },
      { week:"Week 8", titleKo:"전치사", titleEn:"Prepositions", point:"at (time/point), on (day/surface), in (month/space)" }
    ],

    dialogues: [
      {
        titleKo:"종합 복습 - 새 친구 만나기",
        titleEn:"Review - Meeting a New Friend",
        lines:[
      ...
      {
        titleKo:"종합 복습 - 하루 일과 이야기",
        titleEn:"Review - Talking About Your Day",
        lines:[
  ...
  ,week10: {
    ...
    /* Conversation prompts organized by theme */
    conversationCards: [
      {
    ...
    /* Full role-play scenarios for the conversation day */
    rolePlayScenarios: [
      {
        ...
        usefulPhrases:["I would like...", "Does it come with...?", "How much is...?", "Can I have the check?"]
      },
      {
        ...
        usefulPhrases:["Excuse me, where is...?", "Go straight...", "Turn left/right", "Is it far?"]
      },
      {
    ...
    /* Celebration vocabulary - graduation themed */
    vocabulary: [
